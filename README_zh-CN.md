...
一个 [MCP (Model Context Protocol)](https://modelcontextprotocol.io/) 服务器，用于查找 Minecraft 混淆名称映射。专为需要访问 Minecraft 原生内部 API 的 [CustomNPCs](https://www.kodevelopment.nl/customnpcs/) (CNPC) 脚本 AI 编程助手设计。
